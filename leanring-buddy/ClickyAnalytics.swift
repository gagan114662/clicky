...
//  leanring-buddy
//
//  Centralized analytics hooks. Production beta builds intentionally keep
//  these hooks local no-ops until ipop.ai has an explicit analytics policy.
//
...
enum IpopAnalytics {
    ...
    /// The onboarding demo interaction where ipop.ai points at something.
